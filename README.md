...
Current status: sample-mode MVP. It demonstrates the diagnostic workflow, analyzer rules, local history, JSON/HTML reports, and frontend/backend architecture. Real Microsoft Graph collection is planned as a future read-only operational step.

### [DNS Audit Tool](https://github.com/RafaelAlbaWebify/dns-audit-tool)

PowerShell-based DNS auditing tool with a WPF GUI, CSV reporting, finding classification, and operational notes for support teams.

It focuses on practical DNS issues that often appear as unrelated support symptoms: authentication failures, intermittent application errors, Outlook/Teams connection issues, slow access, or inconsistent name resolution.
...
- B2B services available through Webify Digital Solutions Ltd, Ireland
